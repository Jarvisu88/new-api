...
const SITE_SECTIONS = [
  ...
  },
  {
    id: 'top-banner',
    titleKey: 'Top Banner',
    descriptionKey: 'Configure the global top banner',
    build: (settings: SiteSettings) => (
      <BannerSection
        defaultValues={{
          ...
          BannerSpeed: settings.BannerSpeed,
          BannerVisualConfig: settings.BannerVisualConfig,
          BannerCustomCSS: settings.BannerCustomCSS,
