...
type ConsoleSetting struct {
	...
	StatusPageDomain           string `json:"status_page_domain"`
	StatusPageTitle            string `json:"status_page_title"`
	StatusPageDescription      string `json:"status_page_description"`
	StatusPageTimezone         string `json:"status_page_timezone"`
}
...
var defaultConsoleSetting = ConsoleSetting{
	...
	StatusPageDomain:           "",
	StatusPageTitle:            "系统状态",
	StatusPageDescription:      "服务可用性与事件更新",
	StatusPageTimezone:         "Asia/Shanghai",
}
